...
public class DegradeController {
	...
	public Result<List<DegradeRuleEntity>> queryMachineRules(String app, String ip, Integer port) {
		...
		try {
			List<DegradeRuleEntity> appNacosRules = getRulesFromNacosByApp(app);
			repository.saveAll(appNacosRules);
			return Result.ofSuccess(appNacosRules);
	...
	private List<DegradeRuleEntity> getRulesFromNacosByApp(String app) throws Exception {
	...
	private boolean publishRules(String app, String ip, Integer port) {
		...
		try {
			...
			logger.error("Error when publishing degrade rules, app={}", app);
			return false;
		}
		return true;
	}
